...
const char* mqtt_server = "192.168.129.242";
...
void loop()
{
  ...
  mqttClient.loop();
    ...
    // Publish a random sensor value
  int sensorValue = random(20, 30);  // Simulated sensor data (0-100)
  String message = String(sensorValue);
  String formattedMessage = "[SensorValue]: " + message;  // Add a label to the message
